        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 mb-20 reveal">
          ...
          <div className="lg:col-span-7 flex flex-col justify-end pt-4">
            <p className="font-body text-[22px] lg:text-[28px] leading-[1.4] text-charcoal mb-8 text-balance">
              ARTHA builds borderless payment infrastructure for the internet economy — so that developers anywhere can capture the value they create without seeking permission from traditional financial gatekeepers.
            </p>
          ...
          <div className="lg:col-span-8 flex flex-col">
            ...
            <div className="flex flex-col md:flex-row gap-8 justify-between items-start">
              ...
              <div className="flex flex-col md:w-[320px] shrink-0">
                ...
                <p className="font-body text-[16px] text-text-secondary leading-relaxed">
                  Smart contracts talk in bytecode but think in pure logic. In this paper, we detail how ARTHA translates legal subscription terms into immutable on-chain agreements.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="lg:col-span-8 flex flex-col">
              ...
              <div className="flex flex-col">
                {[
                  ...
                  { d: "May 7, 2026", c: "Cryptography", t: "Focus areas for The ARTHA Institute" },
                ].map((row, i) => (
