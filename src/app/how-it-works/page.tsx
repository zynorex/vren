      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 mb-20 reveal">
          ...
          <div className="lg:col-span-7 flex flex-col justify-end pt-4">
            <p className="font-body text-[22px] lg:text-[28px] leading-[1.4] text-charcoal mb-8 text-balance">
              The mechanics of autonomy. A precise technical breakdown of how the ARTHA protocol replaces traditional fiat gateways with absolute programmatic certainty.
            </p>
        ...
        <div className="border-t border-b border-border-subtle py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16 reveal">
          ...
          <div className="flex flex-col">
            ...
            <p className="font-body text-[16px] text-text-secondary leading-relaxed">
              Users interact with the ARTHA frontend. The specified crypto funds are transferred into your vault, and a unique cryptographic token representing their subscription is minted.
            </p>
          </div>
          <div className="flex flex-col">
          ...
          <div className="lg:col-span-8 flex flex-col">
            ...
            <div className="flex flex-col md:flex-row gap-8 justify-between items-start">
              ...
              <div className="flex flex-col md:w-[320px] shrink-0">
                ...
                <p className="font-body text-[16px] text-text-secondary leading-relaxed">
                  Unlike traditional gateways that rely on centralized databases and fragile HTTP webhooks, ARTHA uses immutable smart contracts to guarantee access and settlement mathematically.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-20 reveal">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-16">
            ...
            <div className="lg:col-span-8 flex flex-col">
              ...
              <div className="flex flex-col">
                {[
                  { d: "ArthaSubscription", c: "Solidity", t: "Core ERC-1155 token contract with tiered subscription logic" },
                  { d: "ArthaRegistry", c: "Solidity", t: "Factory contract for tracking individual builder deployments" },
